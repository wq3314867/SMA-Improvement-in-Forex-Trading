...
data<-read.csv("GBP_USD.csv",header=T)
...
write.table(T1,"GBPP3.txt",row.names=FALSE)
...
write.table(T2,"GBPMA.txt",row.names=FALSE)
...
write.table(T3,"GBPL3.txt",row.names=FALSE)
...
indexL3<-read.table("GBPL3pair.txt")
...
indexP3<-read.table("GBPP3pair.txt")
...
indexMA<-read.table("GBPMApair.txt")
...
par(mfrow=c(2,2))
plot(cumretL3,xlab="GBP Cummulative Return By Logrithm",col="red",type="l",lwd=3)
plot(cumretMA,xlab="GBP Cummulative Return SMA",col="green",type="l",lwd=3)
plot(cumretP3,xlab="GBP Cummulative Return Powered MA",col="blue",type="l",lwd=3)
