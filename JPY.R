...
data<-read.csv("USD_JPY.csv",header=T)
...
write.table(T1,"JPYP3.txt",row.names=FALSE)
...
write.table(T2,"JPYMA.txt",row.names=FALSE)
...
write.table(T3,"JPYL3.txt",row.names=FALSE)
...
indexL3<-read.table("JPYL3pair.txt")
...
indexP3<-read.table("JPYP3pair.txt")
...
indexMA<-read.table("JPYMApair.txt")
...
par(mfrow=c(2,2))
plot(cumretL3,xlab="JPY Cummulative Return By Logrithm",col="blue",type="l",lwd=3)
plot(cumretMA,xlab="JPY Cummulative Return SMA",col="green",type="l",lwd=3)
plot(cumretP3,xlab="JPY Cummulative Return Powered MA",col="red",type="l",lwd=3)
